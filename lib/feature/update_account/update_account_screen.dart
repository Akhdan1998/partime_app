...
class UpdateProfile extends StatefulWidget {
  const UpdateProfile({super.key, required this.role});
...
class _UpdateProfileState extends State<UpdateProfile> {
  ...
  void initState() {
    super.initState();
    controller = Get.put(UpdateProfileController(role: widget.role));
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CusAppBar(
        title: controller.isCompany ? 'My Company' : 'My Profile',
      ),
      body: SafeArea(
        bottom: false,
