...
class JobDetailsController extends GetxController {
  ...
  /// MINIMUM EDUCATION
  /// =========================
  final minEducation = <MinimumEducation>[
    MinimumEducation(id: '1', minEducation: 'Elementary school'),
    MinimumEducation(id: '2', minEducation: 'Junior High School'),
    MinimumEducation(id: '3', minEducation: 'Vocational school'),
    MinimumEducation(id: '4', minEducation: 'D1 - D4'),
    MinimumEducation(id: '5', minEducation: 'Bachelor degree'),
    MinimumEducation(id: '6', minEducation: 'Master'),
    MinimumEducation(id: '7', minEducation: 'Doctor'),
  ].obs;
  ...
  /// EMPLOYMENT POLICY
  /// =========================
  final employmentPolicy = <EmploymentPolicy>[
    EmploymentPolicy(id: '1', employmentPolicy: 'Remote'),
    EmploymentPolicy(id: '2', employmentPolicy: 'On-Site'),
    EmploymentPolicy(id: '3', employmentPolicy: 'Hybrid'),
  ].obs;

  final selectedCategory = Rxn<JobCategory>();
  final selectedGender = Rxn<Gender>();
  final selectedEmploymentPolicy = Rxn<EmploymentPolicy>();
  final selectedMinEducation = Rxn<MinimumEducation>();
  final selectedJobField = Rxn<JobField>();
  final TextEditingController workExperience = TextEditingController();
  final TextEditingController vacanciesAvailable = TextEditingController();
